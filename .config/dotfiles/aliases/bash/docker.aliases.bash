...
alias dcelc='docker exec -it $(docker ps -l -q) sh -c "bash --login || ash --login || sh --login"' # Enter last container (works with Docker 1.3 and above)
alias dcrmflast='docker rm -f $(docker ps -l -q)'
alias dcbash='dcelc'
